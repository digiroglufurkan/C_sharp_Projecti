...
namespace Pakkolinen_Ryhmä_Projecti
{
    public partial class Rekistreidy : Form
    {
        ...
        //Valitaa ja Laata  Profilli Kuva
        string profilikuvatie;
        private void RetiedostoBT_Click(object sender, EventArgs e)
        {
            openFileDialogProfiliKuva.Title = "Valitse Kuva";
            openFileDialogProfiliKuva.Filter = "Image File(*.png;*.jpg;*.gif;*.bmp)|*.png;*.jpg;*.gif;*.bmp";
            if (openFileDialogProfiliKuva.ShowDialog() == DialogResult.OK)
            {
