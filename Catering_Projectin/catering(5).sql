...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2022 at 11:25 PM
...
(1, 1, 'test', '5fImWtntiKpjthgb9yyGWg==', 'Enimi', 'Snimi', 'email', 564598756, '', 'gregerg', 'wrbwbww', 54321, 0),
(3, 2, 'kayt', '5p1JyJ2eO8ZLbj4YdCEWyA==', 'ka', 'ka', 'email', 2563245, '', 'Jokin', 'paikka', 12345, 6),
(5, 2, 'furkan', 'b3hnh6fTyeQxc4Eg057AMg==', 'furkan', 'digiroglu', 'furkan.digiroglu@gmail.com', 452613111, 'mr', 'vantaa', 'vantaa', 1370, 4),
(6, 2, 'te.te', '5p1JyJ2eO8ZLbj4YdCEWyA==', 'te', 'te', 'tet', 434, '', 'gewgw', 'gewgew', 343, 0),
(8, 3, 'ko.ko', 'kakA40xPpU7SixnadKjgyw==', 'ko', 'ko', 'rvrev', 585858, '', 'grtge', 'egter', 55555, 0),
(13, 2, 'te.te', '5p1JyJ2eO8ZLbj4YdCEWyA==', 'te', 'te', 'tet', 43, '', 'gwrg', 'wgw', 23, 16);
...
--
-- Dumping data for table `tyotilanne`
--

INSERT INTO `tyotilanne` (`TyoID`, `Kayttajatunnus`, `TilausID`, `Status`, `LentoID`) VALUES
(11, 'ko.ko', 21, 1, 2);
...
ALTER TABLE `tyotilanne`
  ...
  ADD KEY `Lento` (`LentoID`) USING BTREE;
...
--
ALTER TABLE `kayttajat`
  MODIFY `KayttajaID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `lentoyhtionyhteyshenkilot`
  MODIFY `YhtioID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tyotilanne`
  MODIFY `TyoID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
