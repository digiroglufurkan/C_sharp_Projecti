...
(1, 'Pizza', 'Vehnäjauhoista tehty pohja, tomaattikastiketta, juustoa, kinkkua, pekonia, ananasta', 'Ruoka', 8, 0, 0);
...
INSERT INTO `tilausyhdiste` (`YhdisteID`, `AteriatID`, `JuomaAlkoID`, `JuomaID`) VALUES
(5, 1, 1, 1);
...
ALTER TABLE `tilaus`
  ...
  ADD UNIQUE KEY `YhdisteID` (`YhdisteID`),
  ADD KEY `StatusID` (`Status`),
  ADD KEY `YhdisteID_2` (`YhdisteID`);

--
-- Indexes for table `tilausyhdiste`
--
ALTER TABLE `tilausyhdiste`
  ADD PRIMARY KEY (`YhdisteID`),
...
--
ALTER TABLE `juomatalkoholittomat`
  MODIFY `JuomaID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tilausyhdiste`
--
ALTER TABLE `tilausyhdiste`
  MODIFY `YhdisteID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tilaus`
  ADD CONSTRAINT `YhdisteAvain` FOREIGN KEY (`YhdisteID`) REFERENCES `tilausyhdiste` (`YhdisteID`) ON DELETE CASCADE ON UPDATE NO ACTION;
